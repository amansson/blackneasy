...
const Puppies = () => {
    ...
    const [showMother7, setShowMother7] = useState(false);
    ...
    const toggleAll = () => {
        ...
        setShowMother7(false);
    }

    return (
        <Fragment>
            <div className="wrapper">
                <h2 className="notice-action">Klicka på Mamma - Pappa för att se deras valparna och scrolla</h2>
                <div className="card-puppies">
                    ...
                    <PuppiesSelect toggle={toggleMother7} imageMother={"profile/Shantis_profile"} imageFather={"profile/Kazan_profile"} nameMother={"Shantis"} nameFather={"Kazan"} />
                </div>
                ...
                {showMother7 ?
                    <div className="select-divider">
                        <h2 className="text-align-center">Shantis och Kazan</h2>
                        <div className="wrapper puppies-images">
                            <PuppiesContent puppies={"puppies_shantis_kazan"} />
                        </div>
                    </div>
                    : ""}
            </div>
